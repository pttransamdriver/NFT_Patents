...
export const NETWORK_CONFIG = {
  localhost: {
    ...
    gasPrice: "auto",
    accounts: {
      // Set LOCALHOST_PRIVATE_KEY in your .env to a Hardhat test account private key.
      // Run `npx hardhat node` to see available test accounts and their keys.
      deployer: process.env.LOCALHOST_PRIVATE_KEY
    }
  },
